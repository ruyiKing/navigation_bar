...
<!-- style="margin:20px 0;text-align: right;" -->
	...
	<div id="toolbar">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="createBarClassify()">新建网址</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editBarClassify()">编辑网址</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyBarClassify()">删除网址</a>
    </div>
    ...
    <table id="dg" title="导航分类列表" class="easyui-datagrid" style="width:100%;height:365px;"
        ...
        <thead>
            <tr>
                ...
                <th field="classifyName" width="50">网址名称</th>
                <th field="dateCreated" width="50">网址URL</th>
